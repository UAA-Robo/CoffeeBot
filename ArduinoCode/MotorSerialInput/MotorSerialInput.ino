...
// #define servo_pin 23 // A0 on board
    ...
    */
    if (input.length() > 0) {
      ...
      if (command_type == 'V' && device_type == 'M') {
        ...
        // if (stepper_index <= 6)
          steppers[stepper_index].setSpeed(velocity);
        // else if (stepper_index == 6 && claw_position < 180 && claw_position > 0) {// Claw Servo
        //   if (velocity > 0) claw_position += 1;
        //   else claw_position -= 1;
        //   if (velocity != 0 ) claw_servo.write(claw_position);
        // }
      }
    }
  }
